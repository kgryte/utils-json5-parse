...
fpath = path.join( __dirname, 'fixtures', 'config.json5' );
...
describe( 'utils-json5-parse', function tests() {
	...
	it( 'should return a parsed JSON object based on JSON5', function test() {
